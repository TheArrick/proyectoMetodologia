 ...
 * Además, implementa la interfaz Comparable para comparar eventos por
 * prioridad.
 */
public class Evento extends Pendiente implements Comparable<Evento> {
    ...
    // Implementacion de getHORA Y getFecha para la implementacion de no tener
    // tareas con fechas repetidads
    public Hora getHora() {
        return hora;
    }
    ...
    public String toString() {
        return titulo + "|" + descripcion + "|" + hora.toStringSerializado() + "|" + fecha.toStringSerializado() + "|"
                + lugar + "|" + prioridad + "|" + seRepite();
    } // unir
